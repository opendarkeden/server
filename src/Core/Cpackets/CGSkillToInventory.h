...
public:
	...
	PacketSize_t getPacketSize() const  { return szSkillType + szObjectID + szCoordInven*4; }
...
public:
	...
	PacketSize_t getPacketMaxSize() const  { return szSkillType + szObjectID + szCoordInven*4; }
};
