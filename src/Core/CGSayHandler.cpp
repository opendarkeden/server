...
void CGSayHandler::oppay(GamePlayer* pGamePlayer , string msg, int i)
{
	...
	else if (pGamePlayer->isPayPlaying())
	{
		...
		{
			sprintf(str, "%sʣ��ʱ�� : %d / %d ��", str, (int)(payTime.tv_sec/60), (int)pGamePlayer->getPayPlayAvailableHours());
		}
	}
	else
	{	
...
//					break;
	...
	else if ( command == "ZoneEvent" )
	{
		...
		else if ( value1 == "on" )
		{
			...
			else gcSystemMessage.setMessage("�Ѽ��������.");
		}
		else if ( value1 == "off" )
		{
			...
			else gcSystemMessage.setMessage("���û������.");
		}
	}
