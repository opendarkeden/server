...
{
public:
	virtual ActionType_t getActionType() const  { return ACTION_REGISTER_REINFORCE; }
...
{
public:
	virtual ActionType_t getActionType() const  { return Action::ACTION_REGISTER_REINFORCE; }
	virtual string getActionName() const  { return "RegisterReinforce"; }
	virtual Action* createAction() const  { return new ActionRegisterReinforce(); }
};
#endif
