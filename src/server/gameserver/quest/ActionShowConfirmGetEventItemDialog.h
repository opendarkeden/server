...
public:
    virtual ActionType_t getActionType() const {
        return ACTION_SHOW_CONFIRM_GET_EVENT_ITEM_DIALOG;
    }
...
public:
    virtual ActionType_t getActionType() const {
        return Action::ACTION_SHOW_CONFIRM_GET_EVENT_ITEM_DIALOG;
    }
    virtual string getActionName() const {
        return "ShowConfirmGetEventItemDialog";
    }
    virtual Action* createAction() const {
        return new ActionShowConfirmGetEventItemDialog();
    }
};
