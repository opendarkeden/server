...
public:
    EffectClass getEffectClass() const {
        return EFFECT_CLASS_DROP_BLOOD_BIBLE;
    }
    EffectClass getSendEffectClass() {
        return (EffectClass)((int)EFFECT_CLASS_BLOOD_BIBLE_ARMEGA + m_ItemType);
    }

    ItemType_t getPart() const {
        return m_ItemType;
    }
    void setPart(ItemType_t part) {
        m_ItemType = part;
    }
...
public:
    virtual Effect::EffectClass getEffectClass() const {
        return Effect::EFFECT_CLASS_DROP_BLOOD_BIBLE;
    }
    virtual string getEffectClassName() const {
        return "EffectDropBloodBible";
    }
