	...
	throw(Error)
{
	...
	if (pPC->isSlayer() )
	{
		...
		for (Slayer::WearPart i = Slayer::WEAR_FINGER1 ; i <= Slayer::WEAR_FINGER4 ; i = Slayer::WearPart(i + 1))
		{
...
//					pSlayer->deleteWearItem(i);
	...
	else if (pPC->isVampire() )
	{
		...
		for (Vampire::WearPart i = Vampire::WEAR_FINGER1 ; i <= Vampire::WEAR_FINGER4 ; i = Vampire::WearPart(i + 1))
		{
