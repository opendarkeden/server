...
public:
    ...
    VSDateTime addSecs(int t) {
        return VSDateTime(m_Time + t);
    }

    bool operator<=(const VSDateTime& t) const {
...
public:
    static void setCurrentDateTime(int t) {
        s_CurrentDateTime = VSDateTime(t);
    }
