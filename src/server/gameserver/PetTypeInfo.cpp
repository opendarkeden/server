...
void PetTypeInfoManager::load() {
	...
	BEGIN_DB {
		...
		pResult = pStmt->executeQuery("SELECT PetType, OriginalMonsterType, CreatureType1, CreatureType2, CreatureType3, CreatureType4, CreatureType5, FoodType FROM PetTypeInfo");
