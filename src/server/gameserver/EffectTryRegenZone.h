...
public:
    ...
    EffectClass getEffectClass() const {
        return (EffectClass)(Effect::EFFECT_CLASS_SLAYER_TRYING_1 + (m_OwnerRace * 3));
    }
    EffectClass getSendEffectClass() const {
        return (EffectClass)(getEffectClass() + m_Progress);
    }
    ...
    void setProgress(uint pro) {
        m_Progress = pro;
    }

    string toString() const {
        return "EffectTryRegenZone";
    }
