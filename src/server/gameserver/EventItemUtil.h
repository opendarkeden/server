...
enum LuckyBag { NO_LUCKY_BAG, GREEN_LUCKY_BAG, BLUE_LUCKY_BAG, GOLD_LUCKY_BAG, RED_LUCKY_BAG };

LuckyBag getLuckyBagKind(PlayerCreature* pPC, Monster* pMonster);
Item* getLuckyBagItem(LuckyBag luckybag);

enum GiftBox { NO_GIFT_BOX, RED_GIFT_BOX, BLUE_GIFT_BOX, GREEN_GIFT_BOX, YELLOW_GIFT_BOX };
