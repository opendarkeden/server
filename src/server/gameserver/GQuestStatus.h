...
public:
    GQuestStatus(PlayerCreature* pOwner, DWORD QuestID)
        : QuestStatusInfo(QuestID), m_pOwner(pOwner), m_pGQuestInfo(NULL) {}
    GQuestStatus(PlayerCreature* pOwner, GQuestInfo* pGQuestInfo)
        : QuestStatusInfo(pGQuestInfo->getQuestID()), m_pOwner(pOwner), m_pGQuestInfo(pGQuestInfo) {}
    ~GQuestStatus();
