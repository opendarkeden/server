...
public:
    ...
    DWORD getSubjectCode(uint index) const {
        return m_SubjectCodes[index];
    }
    void setSubjectCode(uint index, DWORD code) {
        m_SubjectCodes[index] = code;
    }
    ...
    // by sigi. 2002.12.3
    DWORD getContentCode(uint index) const {
        return m_ContentCodes[index];
    }
    void setContentCode(uint index, DWORD code) {
        m_ContentCodes[index] = code;
    }

    string getRandomSubject(void) const;

    uint getSubjectCount(void) const {
        return m_SubjectCount;
    }
    uint getContentCount(void) const {
