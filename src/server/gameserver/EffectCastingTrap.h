...
public:
    ...
    EffectCastingIcicleTrap(EffectClass IcicleEffect, Zone* pZone)
        : Effect(pZone, 0, 0, NULL, 99999999), m_IcicleEffect(IcicleEffect), m_bLarge(false) {}

    void setStartXY(ZoneCoord_t x, ZoneCoord_t y) {
        m_StartX = x;
        m_StartY = y;
    }
    ...
    string toString() const {
        return "EffectCastingIcicleTrap";
    }
