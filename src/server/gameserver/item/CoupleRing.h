...
public:
	virtual ItemClass getItemClass() const  { return Item::ITEM_CLASS_COUPLE_RING; }
	virtual string getObjectTableName() const  { return "CoupleRingObject"; }
...
{
public:
	virtual Item::ItemClass getItemClass() const  { return Item::ITEM_CLASS_COUPLE_RING; }
	virtual string toString() const ;
...
public:
	virtual Item::ItemClass getItemClass() const  { return Item::ITEM_CLASS_COUPLE_RING; }
	virtual string getItemClassName() const  { return "CoupleRing"; }
