...
public:
    MeetNPCQuestInfo(QuestID_t questID, Race_t race, QuestGrade_t maxGrade, QuestGrade_t minGrade, DWORD timeLimitSec,
                     RewardClass_t rClass, NPCID_t npcID, NPCID_t npcID2);
    ~MeetNPCQuestInfo();
