...
class QuestInfo {
public:
    QuestInfo(QuestID_t qID, Race_t race, QuestGrade_t maxGrade, QuestGrade_t minGrade, DWORD timeLimitSec,
...
public:
    ...
    void setEventQuest(bool bEvent = true) {
        m_bEventQuest = bEvent;
    }
    void setQuestLevel(int qLevel) {
        m_QuestLevel = qLevel;
    }
