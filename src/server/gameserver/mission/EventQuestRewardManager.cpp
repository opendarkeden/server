...
void EventQuestRewardManager::load(const string& name) {
    ...
    BEGIN_DB {
        ...
        /*		pStmt = g_pDatabaseManager->getConnection("DARKEDEN")->createStatement();
                ...
                pResult = pStmt->executeQuery("SELECT RewardClass, RewardID, QuestLevel FROM EventQuestRewardInfo WHERE
           NPC='%s'", name.c_str());
        ...
        ItemRewardInfo WHERE NPC='%s'", name.c_str());
        ...
        pResult = pStmt->executeQuery("SELECT RewardClass, RewardID, IClass, IType, OptionType, TimeLimitSec FROM
        SlayerWeaponRewardInfo WHERE NPC='%s'", name.c_str());
