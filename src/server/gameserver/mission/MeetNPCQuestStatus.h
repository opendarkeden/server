...
public:
    MeetNPCQuestStatus(QuestID_t qID, const VSDateTime& deadline, NPCID_t npcID, NPCID_t npcID2)
        : QuestStatus(qID, deadline, QUEST_CLASS_MEET_NPC) {
        m_TargetNPCID[0] = npcID;
        m_TargetNPCID[1] = npcID2;
        m_bMet[0] = false;
        m_bMet[1] = false;
    }
