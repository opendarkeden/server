...
public:
    ...
    MonsterType_t getOriginalMonsterType() const {
        return m_OriginalMonsterType;
    }
    MonsterType_t getPetCreatureTypeByIndex(uint index) const {
        return m_PetCreatureType[index];
    }
