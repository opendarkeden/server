...
public:
    EffectClass getEffectClass() const  { return EFFECT_CLASS_SHRINE_GUARD; }
    EffectClass getSendEffectClass() const  { return (EffectClass)((int)EFFECT_CLASS_SHRINE_GUARD + m_ShrineID); }
