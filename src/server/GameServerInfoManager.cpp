...
//Commented out since the inside was already commented anyway
/*
void GameServerInfoManager::clear() throw(Error) {
...
void GameServerInfoManager::load() throw(Error) {
    ...
    */
    ...
    BEGIN_DB {
        pStmt = g_pDatabaseManager->getConnection("DARKEDEN")->createStatement();
        Result* pResult = pStmt->executeQuery("SELECT `ServerID`, `Nickname`, `IP`, `TCPPort`, `UDPPort`, `WorldID`, `GroupID`, `Stat` FROM `GameServerInfo`");
...
void GameServerInfoManager::addGameServerInfo(GameServerInfo * pGameServerInfo, const ServerGroupID_t ServerGroupID, WorldID_t WorldID) throw(DuplicatedException) {
    __BEGIN_TRY
    ...
    if (itr != m_pGameServerInfos[WorldID][ServerGroupID].end())
        throw DuplicatedException("duplicated gameserver ServerID");
...
void GameServerInfoManager::deleteGameServerInfo(const ServerID_t ServerID, const ServerGroupID_t ServerGroupID, WorldID_t WorldID) throw(NoSuchElementException) {
    __BEGIN_TRY
...
// get info
//----------------------------------------------------------------------
GameServerInfo * GameServerInfoManager::getGameServerInfo(const string & nickname) const throw(NoSuchElementException) {
    __BEGIN_TRY
...
GameServerInfo * GameServerInfoManager::getGameServerInfo(const ServerID_t ServerID, const ServerGroupID_t ServerGroupID, WorldID_t WorldID) const throw(NoSuchElementException) {
    __BEGIN_TRY
